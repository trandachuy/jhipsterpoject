...
@RestController
@RequestMapping("/api/jhipster-project-application-kafka")
public class JhipsterProjectApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterProjectApplicationKafkaResource.class);
    ...
    public JhipsterProjectApplicationKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
